...
# Directory only: auth for the daily mechanics export fetched during
...
ARG NEXT_PUBLIC_CHAT_EMBED_ORIGIN
...
ENV NEXT_PUBLIC_CHAT_EMBED_ORIGIN=${NEXT_PUBLIC_CHAT_EMBED_ORIGIN}
